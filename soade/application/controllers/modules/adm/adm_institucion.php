...
class Adm_institucion extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('modules/adm_institucion_model');
	...
	function index()
	{
		if($this->session->userdata('us_usuario'))
		{
			...
			$this->load->view('modules/adm/view_adm_institucion',$data);
	...
	function create()
	{
		$data = array(
			...
			'in_fecha' => $this->input->post('in_fecha'),
			'in_codigo' => $this->input->post('in_codigo'),
			'in_estado' => $this->input->post('in_estado'),
			'in_idarchivo' => $this->input->post('in_idarchivo'),
			 ); 

		$msn = array(); 

		$result=$this->adm_institucion_model->create($data);
		$data['in_idinstitucion'] = $this->db->insert_id();
	...
	function get_by_id()
	{
		...
		$result=$this->adm_institucion_model->get_by_id($id);
	...
	function get_all_paginate()
	{
		...
		$data = $this->adm_institucion_model->get_all_paginate($data);
	...
	function get_all()
	{
		...
		$result=$this->adm_institucion_model->get_all();
		echo json_encode($result);
	...
	function update()
	{
		...
		$id =$this->input->post('in_idinstitucion');

		$result=$this->adm_institucion_model->update($id,$data);
		$data['in_idinstitucion'] = $id;
	...
	function delete()
	{
		...
		$result=$this->adm_institucion_model->delete($id,$data);
		$data['in_idinstitucion'] = $id;
...
//		$this->audit->setItem($add['in_idinstitucion']);
