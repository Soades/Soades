...
class Algo extends CI_Controller
{
	...
	function index()
	{
		if($this->session->userdata('us_usuario'))
		{
			...
			$this->load->view('alg/view_algo',$data);
	...
	function create()
	{
		...
		$result=$this->algo_model->create($data);
	...
	function get_by_id()
	{
		...
		$result=$this->algo_model->get_by_id($id);
	...
	function get_all_paginate()
	{
		...
		$data = $this->algo_model->get_all_paginate($data);
	...
	function get_all()
	{
		...
		$result=$this->algo_model->get_all();
		echo json_encode($result);
	...
	function update()
	{
		...
		$result=$this->algo_model->update($id,$data);
		$data['Id'] = $id;
	...
	function delete()
	{
		...
		$result=$this->algo_model->delete($id,$data);
		$data['Id'] = $id;
