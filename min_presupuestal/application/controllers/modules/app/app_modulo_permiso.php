...
class App_modulo_permiso extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('modules/app/app_modulo_permiso_model');
    }
    ...
    function index() {
        if ($this->session->userdata('us_usuario')) {
            ...
            $this->load->view('modules/app/view_app_modulo_permiso', $data);
            $this->AddAudit(array('mp_idmope' => ""), ACCESO);
        } else {
    ...
    public function AddAudit($add, $permiso) {
        ...
        $this->audit->setItem(isset($add['mp_idmope']) ? $add['mp_idmope'] : "");
