...
class ParReferencias_model extends CI_Model {
    ...
    public function create($records) {
        $this->db->insert('par_licencia_funcionamiento', $records);
    }

    public function update($records) {
        $this->db->where('lf_id_lf', $records['lf_id_lf']);
        return $this->db->update('par_licencia_funcionamiento', $records);
    }
}
