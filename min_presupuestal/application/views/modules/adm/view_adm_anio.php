...
<div class="content-app fixed-header">
    ...
    <div class="app-header">
        <div class="pull-right">
            <a class="btn btn-default" id="adm_anio_listar" role="button">
                <i class="glyphicon glyphicon-list" ></i>
            </a>
            <a class="btn btn-default" id="adm_anio_nuevo" role="button">
                <i class="glyphicon glyphicon-file" ></i>
            </a>
            <a class="btn btn-default" id="adm_anio_eliminar" role="button">
                <i class="glyphicon glyphicon-trash" ></i>
            </a>
            <a class="btn btn-default" id="adm_anio_guardar" role="button">
        ...
        <div class="isotope" >
            <div id="panel-custom2" class="panel panel-default magic-element isotope-item" >
                <div class="panel-heading bg-primary text-inverse bordered-none">
                    ...
                    <h3 class="panel-title">Gestion de años</h3>
                </div>
                <div class="panel-body bordered-none">
                    <form style="display:none;" class="form-horizontal" id="form_adm_anio" role="form">
                        <input style="display: none;" type="text" class="tabcontrol form-control" value="" 
                               id="an_idanio" name="an_idanio"/>
                        <fieldset>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input">Año</label>
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <span class="input-group-addon bg-peterriver">
                                            <i class="icon ion-ios7-calculator-outline"></i>
                                        </span>
                                        <input type="text" id="an_nombre" name="an_nombre"
                                               class="form-control" >
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="3" id="an_descripcion" name="an_descripcion" class="form-control" id="inputTextarea"></textarea>
                                </div>
                            </div>
                        </fieldset>
                    </form>

                    <div id="div_lista_adm_anio" class="table-responsive">                                       
                        <!--                        <div id="adm_anio" class="highlight">
...
<!-- *** SHOW ROLES *** -->
<div class="options-adm_anio hide">
    <div class="btn-group">
        ...
        <ul role="menu" class="dropdown-menu dropdown-light pull-right">
            <li>
                <a  class="show-subviews nuevo-adm_anio" href="#newadm_anio" data-startFrom="right" >
                    <i class="fa fa-file-o"></i>       Nuevo
                </a>
            </li>

            <li>
                <a href="#newadm_anio" class="show-subviews edit-adm_anio">
                    <i class="fa fa-pencil"></i> Editar
                </a>
            </li>
            <li>
                <a href="#" class="eliminar-adm_anio">
                    <i class="fa fa-times"></i> Eliminar
                </a>
            </li>
            <li>
                <a href="#" class="auditoria-adm_anio">
...
<script src="<?php echo BASE; ?>public/template/ministerio/js/modulos/adm/js_adm_anio.js" type="text/javascript"></script>
