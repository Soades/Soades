...
<div id="newpar_paises" style="display: none"  >
    <div class="noteWrap col-md-8 col-md-offset-2">
        <form class="form-par_paises form-horizontal">
            <div class="row">
                <h2><i class="fa fa-pencil-square"></i> REGISTRO</h2>
                <p>
                    Gestion y creacion de par_paises
                </p><input type="text" style="display:none;" id="pa_idpais" name="pa_idpais" /><div class="form-group">
											<label class="col-sm-3 control-label">
												pa_nombre <span class="symbol required"></span>
											</label>
											<div class="col-sm-3">
												<input tabindex="1" type="text" class="tabcontrol form-control pa_nombre" id="pa_nombre" name="pa_nombre" />
											</div>
										</div>
            <div class="pull-right">
                ...
                <div class="btn-group">
                    <button class="btn btn-primary back-step btn-block save-par_paises" type="submit">
...
<div class="panel panel-white">
                ...
                <div class="pull-right">
                    <div class="btn-group">
                        ...
                        <ul role="menu" class="dropdown-menu">
                            ...
                            <li>
                                <a  class="show-sv nuevo-par_paises" href="#newpar_paises" data-startFrom="right" >
                                    Nuevo rol
                                </a>
                            </li>
                            <li>
    ...
    <div class="panel-body ">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">                 
                    <div id="par_paises" class="highlight">
