    ...
    return {
        init: function() {
            r(),
                    ...
                    [
                        url + "public/template/metro/assets/pages/img/login/soade2.png",
                        url + "public/template/metro/assets/pages/img/login/soade3.png",
                        url + "public/template/metro/assets/pages/img/login/soade4.png",
                        url + "public/template/metro/assets/pages/img/login/soade1.png",
                        url + "public/template/metro/assets/pages/img/login/bg1.jpg",
                        url + "public/template/metro/assets/pages/img/login/bg2.jpg",
                        url + "public/template/metro/assets/pages/img/login/bg3.jpg"], {
                fade: 1e3,
                duration: 8e3
            }),
                    $(".forget-form").hide(), document.getElementById('anio').focus()
